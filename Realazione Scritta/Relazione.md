...
Gestire i commenti singoli è molto semplice, infatti ho creato una funzione ‘booleana’ che verifica, tramite la funzione _strchr_, se il carattere preso in input è considerato un carattere di separazione (`.()+-/*=~%<>[];`).
